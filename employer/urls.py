...
urlpatterns = [
    ...
    path('profile/<uuid:employer_id>', views.vuEmployer, name='employerVu'), #chemin de la vue du profile
    path('bulletin/<uuid:employer_id>', views.vuPaiement, name='vuPaiement'),
    path('create-employe/', views.add, name= 'add'), # ajout d'employer
    path('update-employe/<uuid:employer_id>/', views.edit, name='edit'),
    path('delete-employe/<uuid:employer_id>/', views.remove, name='delete'), # ch suppression d'employer
